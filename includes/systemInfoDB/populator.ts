...
(async() => {
	...
	linkBar.stop()
	fs.writeFileSync("includes/systemInfoDB/systemInfo.json", JSON.stringify(systemInfo))
	fs.writeFileSync("includes/systemInfoDB/neighborInfo.json", JSON.stringify(linkInfo))
})()