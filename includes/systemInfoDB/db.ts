...
const systemInfo = JSON.parse(fs.readFileSync("./includes/systemInfoDB/systemInfo.json").toString()) as Record<string, SpectralClass>
const neighborInfo = JSON.parse(fs.readFileSync("./includes/systemInfoDB/neighborInfo.json").toString()) as Record<string, string[]>
