...
const systemInfo = JSON.parse(fs_1.default.readFileSync("./src/systemInfoDB/systemInfo.json").toString());
const neighborInfo = JSON.parse(fs_1.default.readFileSync("./src/systemInfoDB/neighborInfo.json").toString());
class SystemInfoDB {
