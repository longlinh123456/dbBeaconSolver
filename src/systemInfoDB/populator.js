...
(async () => {
    ...
    linkBar.stop();
    fs_1.default.writeFileSync("src/systemInfoDB/systemInfo.json", JSON.stringify(systemInfo));
    fs_1.default.writeFileSync("src/systemInfoDB/neighborInfo.json", JSON.stringify(linkInfo));
})();
